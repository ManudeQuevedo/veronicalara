      ...
      <div className="base-grid">
        <div className="content-basic">
          ...
          <p className="about-text">
            ...
            haber asistido a diversos congresos en temas relacionados con la
            Medicina Materno Fetal. Asimismo, estoy certificada por el Colegio
      ...
      <div>
        ...
        <div className="timeline">
          <VerticalTimeline>
            ...
            <VerticalTimelineElement
              className="vertical-timeline-element--education"
              date="Del 25 de Mayo al 27 de Octubre de 2019"
              iconStyle={{ background: "rgb(66, 198, 186)", color: "#fff" }}
            >
              <h3 className="vertical-timeline-element-title">
                <strong>
                  Diplomado: Uso de laser CO2 en el Tracto Genital Inferior
                </strong>
              </h3>
              <h4 className="vertical-timeline-element-subtitle">
                Colegio Mexicano de Ginecólogos dedicados a la Colposcopía A.C
              </h4>
            </VerticalTimelineElement>
          </VerticalTimeline>
        </div>
          ...
          <div className="grid-1">
            ...
            <div className="about-work-together3">
              <p className="text">
                ...
                discreto, brindando el más alto esfuerzo para lograr nuestro
                principal objetivo: tu bienestar como paciente.
              </p>
              <p className="text">
                Ser tu mejor opción en prevención, enseñanza y tratamiento, en
                todo lo relacionado con el área de Ginecología y Obstetricia,
                para que los problemas de salud no sean una preocupación más
                para tí.
              </p>
            </div>
          </div>

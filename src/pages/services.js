                ...
                <ul className="services-list">
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        Miomatosis Uterina, Histerectomía abierta o Laparoscópico
                      </li>
                      <li>
                  ...
                  <li>
                    Tratamientos con <strong>Laser CO2</strong>
                    <ul>
              ...
              <div className="text">
                <ul className="services-list">
                  ...
                  <li>
                    ...
                    13.6 semanas + tubo marcador detectan trisomia 21, 18, 13
                    (Sindrome de Down, Sindrome de Edwards y Sindrome de Patau))
                  </li>
                  <li>
            ...
            <div className="card-c">
              ...
              <div className="text">
                <ul className="services-list">
                  ...
                  <li>
                    TRATAMIENTO CON LASER PARA LESIONES PRE-CANCEROSAS Y VERRUGAS
                    GENITALES
                  </li>
